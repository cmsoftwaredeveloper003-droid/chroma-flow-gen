        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 items-center">
          ...
          >
            <div className="overflow-hidden">
              <img
                src={amenitiesImg}
                alt="Luxury interior amenities"
                className="w-full h-[350px] md:h-[450px] object-cover transition-transform duration-700 hover:scale-105"
              />
            </div>
          </motion.div>

          {/* Amenity List - right aligned, no bullets */}
          <div className="lg:col-span-2 space-y-0">
            {amenities.map((amenity, index) => (
              ...
              >
                <div
                  className="flex items-center justify-end py-5 transition-colors duration-300 border-b border-border"
                >
